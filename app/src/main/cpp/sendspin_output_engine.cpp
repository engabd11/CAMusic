...
// Ported from Massdroid's sendspin_output_engine.cpp
// (github.com/sfortis/massdroid_native, MIT), unchanged except this note and
// the include of our own header above.
...
void SendspinOutputEngine::onErrorAfterClose(oboe::AudioStream* /*stream*/, oboe::Result error) {
    ...
    // the stream. Flag it so the Kotlin side reopens us — the AudioManager
