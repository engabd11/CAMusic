...
/**
 * Local RGB to HSV. Every layer in this package carries its own copy of this
 * same handful of lines, matching the existing `SongPalette.kt` precedent:
 * sharing it would widen visibility for no gain.
 */
