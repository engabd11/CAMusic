...
private fun blendHue(current: Float, target: Float, weight: Float): Float {
...
/**
 * Local RGB to HSV. [AlbumColours.kt] and `SongPalette.kt` each have their
 * own copy of this same handful of lines for the same reason this one is
 * private to this file — sharing it would widen visibility for no gain.
 */
